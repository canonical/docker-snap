...
gopartbootstrap() 
{
	...
	# setup path to include both $CRAFT_STAGE/bin and $GOPATH/bin
	...
	export PATH="$CRAFT_STAGE/bin:$GOPATH/bin:$PATH"

	# set GOROOT to be whatever the go tool from CRAFT_STAGE/bin is

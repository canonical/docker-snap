...
A subset of `daemon.json` options can be set through snap configuration. This is convenient for unattended and Ubuntu Core deployments, where the values can be provided from a gadget's `defaults`:
